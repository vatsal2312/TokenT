...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 10**15 * 10**18; // 1 Quadrillion "10**15"
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "TokenT";
    ...
    uint256 private B_ServiceFee = 1; // Buy Service Fee
    uint256 private S_ServiceFee = 2; // Sell Service Fee
    uint256 private W_ServiceFee = 0; // Normal W2W Service Fee
    uint256 private _ServiceFee; //main
    ...
    address public MarketingAdd = 0x94B6dfAB0B602eDd49EF3a7c2be40D13241e9cFe; // Marketing & Development Wallet
    address public ServiceAdd = 0xA9dF163F71f3122be9453Ee23E20Df5Bf5012d12; // Service Wallet
